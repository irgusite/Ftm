...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ftm', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\wamp\\www\\Symfony\\src\\Ftm\\blogBundle\\Entity', 1 => 'C:\\wamp\\www\\Symfony\\src\\Ftm\\PlayerBundle\\Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Ftm\\blogBundle\\Entity');
        $f->addDriver($e, 'Ftm\\PlayerBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('FtmblogBundle' => 'Ftm\\blogBundle\\Entity', 'FtmPlayerBundle' => 'Ftm\\PlayerBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\Ftm\\blogBundle/Resources/views', 'Ftmblog');
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\Ftm\\PlayerBundle/Resources/views', 'FtmPlayer');
